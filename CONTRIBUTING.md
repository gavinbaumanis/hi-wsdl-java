...
| Install snapshot locally (optional) | `mvn -B "-Dgpg.skip=true" clean install` - when co-developing with **`hi-b2b-client`** at the same **`${project.version}`** (**1.7.1.1** with **1.7.1.1** on this line; see **README.md**) |
