...
- **Licensed MCA WSDL/XSD download tree:** on **`1.6.6`** and **`1.7.1`**, the full ADHA bundle under **`wsdls/xml/`** (or equivalent) must stay out of Git. This **`1.6.4`** line ships only the standard HI B2B binding WSDL set under **`src/main/resources/`** as published artifact content.
