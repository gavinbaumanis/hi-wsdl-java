...
- **Licensed MCA WSDL/XSD download tree:** on the **`java-11`** / **1.7.1.1** line, the full ADHA bundle under **`wsdls/xml/`** (or equivalent) must stay out of Git. This **`1.6.4.1`** line ships only the standard HI B2B binding WSDL set under **`src/main/resources/`** as published artifact content.
